...
import com.example.ecommerce.databinding.ActivityBuyerHomeBinding;
...
//        recyclerView = findViewById(R.id.recycler_menu);
        ...
        binding.appBarHome.fabCart.setOnClickListener(new View.OnClickListener() {
            ...
            {
                if (!type.equals("Admin")) {
                    Intent intent = new Intent(BuyerHomeActivity.this, BuyerCartActivity.class);
                    startActivity(intent);
                }
            }
        });
        ...
        settingItem.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if (!type.equals("Admin")) {
                    startActivity(new Intent(BuyerHomeActivity.this, BuyerSettingActivity.class));
                    finish();
                }
        ...
        cartItem.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if (!type.equals("Admin")) {
                    startActivity(new Intent(BuyerHomeActivity.this, BuyerCartActivity.class));
                    finish();
                }
        ...
        searchItem.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if (!type.equals("Admin")) {
                    startActivity(new Intent(BuyerHomeActivity.this, BuyerSearchProductActivity.class));
                    finish();
                }
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model)
            {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        if (type.equals("Admin"))
                        {
                            Intent intent = new Intent(BuyerHomeActivity.this, AdminDisapproveProductsActivity.class);
                            intent.putExtra("pid",model.getPid());
                            startActivity(intent);
                        }
                        else
                        {
                            Intent intent = new Intent(BuyerHomeActivity.this, BuyerProductsDetailsActivity.class);
                            intent.putExtra("pid",model.getPid());
                            startActivity(intent);
                        }
                    }
