...
import com.example.ecommerce.databinding.BuyerProductDetailsFragmentBinding;
...
public class ProductDetailsFragment extends Fragment {
    ...
    private BuyerProductDetailsFragmentBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        binding = BuyerProductDetailsFragmentBinding.inflate(inflater, container, false);
...
//        productID = getActivity().getIntent().getStringExtra("pid");
    ...
    private void CheckOrdersState()
    {
        ...
        ordersRef = FirebaseDatabase.getInstance().getReference().child("Orders").child("Pending").child(Prevalent.CurrentOnlineUser.getPhone());
